    ...
    public function view_order($id)
{
    $order = Orders::where('id', $id)
        ->with(['variation.variationBelongsToSize'])
        ->first();
    ...
    return view('admin.orders-management.detail')
...
// color Management
    ...
    {
        $colors = Color::get();
        return view('admin.color-management.list')->with('title', 'Color Management')->with('color_menu', true)->with(compact('colors'));
    }

    public function add_color()
    {
        return view('admin.color-management.add')->with('title', 'Add Color')->with('color_menu', true);
    }
    ...
    public function savecolor(Request $request)
    {
        ...
        $category = Color::where('id', $request->id)->update([
            'name' => $request['title'],
            'slug' => $request['slug'],
            'code' => $request['color'],
        ]);
        ...
        return redirect()->route('admin.color_listing')->with('notify_success', 'Color Updated Successfuly!!');
    }
    ...
    {
        $category = Color::where('id', $id)->delete();
    ...
    public function savesize(Request $request)
    {
        ...
        $category = Size::where('id', $request->id)->update([
            'name' => $request['title'],
            'slug' => $request['slug'],
            'symbol' => $request['symbol'],
        ]);
    ...
    {
        $category = Size::where('id', $id)->delete();
