...
class IndexController extends Controller
{
    ...
    public function customizer(Request $request)
    {
        ...
        $price = $request->price;
        // dd($category_id.' '.$sub_category_id.' '.$product_id);
        // $products = Products::where('is_active',1)->where(['category_id'=>$request->category_id,'sub_category_id'=>$request->sub_category_id])
        // ->with(['productBelongsToCategory','productsHasMultiImages','productBelongsToSubCategory'])->latest()->get();
    ...
    public function product_detail($slug)
{
    ...
    public function check_product_variation(Request $request)
    {
        ...
        if ($variation) {
            // Assuming $variation->price and $variation->id are the price and variation ID respectively
            return response()->json([
                'status' => 1,
                'price' => $variation->our_price,
...
public function cart()
{
    ...
    {
        $blog = Blog::where('id', $id)->with('get_categories')->first();
...
if ($slug) {
    ...
    public function index()
    {
        ...
        $data = compact('latest_blogs', 'sliders', 'galleries', 'testimonial', 'products', 'gallery_chunks', 'galleries', 'parties');
