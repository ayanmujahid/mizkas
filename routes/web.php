...
Route::post('/check-product-variation', [IndexController::class, 'check_product_variation'])->name('check-product-variation');
Route::post('/get-product-sizes', [IndexController::class, 'get_product_sizes'])->name('get-product-sizes');
...
Route::post('/customizer', [IndexController::class, 'customizer'])->name('customizer');
Route::get('/customizer-2/{variation}', [IndexController::class, 'customizer2'])->name('customizer2');
Route::get('/faqs', [IndexController::class, 'faq'])->name('faq');
...
Route::get('/blog-details/{id}', [IndexController::class, 'blog_details'])->name('blog-details');
...
Route::get('/wishlist/count', [IndexController::class, 'count'])->name('wishlist.count');
// ---------------------------------------wishlist---------------------------------------
...
Route::post('/save-customize-design', [CartController::class, 'save_customize_design'])->name('save-customize-design');
Route::post('/place-order', [CartController::class, 'placeorder'])->name('placeorder');
// ---------------------------------------Cart---------------------------------------


// ---------------------------------------Admin---------------------------------------
Route::post('/admin/save-token', function (Illuminate\Http\Request $request) {
...
// ---------------------------------------Inquiries---------------------------------------
  ...
  // ---------------------------------------Color Management---------------------------------------
   Route::get('/color-listing', [AdminDashController::class, 'color_listing'])->name('admin.color_listing');
    Route::get('/add-color', [AdminDashController::class, 'add_color'])->name('admin.add_color');
    Route::post('/create-color', [AdminDashController::class, 'create_color'])->name('admin.create_color');
    Route::get('/edit-color/{id}', [AdminDashController::class, 'edit_color'])->name('admin.edit_color');
    Route::post('/edit-color', [AdminDashController::class, 'savecolor'])->name('admin.savecolor');
    Route::get('/suspend-color/{id}', [AdminDashController::class, 'suspend_color'])->name('admin.suspend_color');
    Route::get('/delete-color/{id}', [AdminDashController::class, 'delete_color'])->name('admin.delete_color');
    // ---------------------------------------Color Management---------------------------------------


// ---------------------------------------Size Management---------------------------------------
    Route::get('/size-listing', [AdminDashController::class, 'size_listing'])->name('admin.size_listing');
    Route::get('/add-size', [AdminDashController::class, 'add_size'])->name('admin.add_size');
    Route::post('/create-size', [AdminDashController::class, 'create_size'])->name('admin.create_size');
    Route::get('/edit-size/{id}', [AdminDashController::class, 'edit_size'])->name('admin.edit_size');
    Route::post('/edit-size', [AdminDashController::class, 'savesize'])->name('admin.savesize');
    Route::get('/suspend-size/{id}', [AdminDashController::class, 'suspend_size'])->name('admin.suspend_size');
    Route::get('/delete-size/{id}', [AdminDashController::class, 'delete_size'])->name('admin.delete_size');
    // ---------------------------------------Size Management---------------------------------------
  ...
  Route::post('/products-bulk-upload-submit', [ShopController::class, 'importProductsCsv'])->name('admin.importProductsCsv');
  Route::get('/products-bulk-upload', [ShopController::class, 'bluck'])->name('admin.bulkUpload');
