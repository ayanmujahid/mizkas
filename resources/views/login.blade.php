        ...
        <div class="tf-grid-layout lg-col-2 tf-login-wrap">
            <div class="tf-login-form">
                <div id="recover">
                    ...
                    <div>
                        <form class=""  id="login-form" action="{{ route('forget_password_submit') }}" method="post" accept-charset="utf-8" data-mailchimp="true">
                            @csrf
                ...
                <div id="login">
                    ...
                    <div>
                        <form class="" id="login-form" action="{{route('login-submit')}}" method="POST" accept-charset="utf-8">
                            @csrf
                            <div class="tf-field style-1 mb_15">
                                <input class="tf-field-input tf-input" placeholder="" type="email" id="property3" name="login_email" value="{{old('login_email')}}">
                                <label class="tf-field-label fw-4 text_black-2" for="property3">Email *</label>
                                @error('login_email')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="tf-field style-1 mb_30">
                                <input class="tf-field-input tf-input" placeholder="" type="password" id="property4" name="login_password">
            ...
            <div class="tf-login-content">
                ...
                <a href="{{route('signup')}}" class="tf-btn btn-line">Register<i class="icon icon-arrow1-top-left"></i></a>
            </div>
        </div>
    </div>
</section>
