...
@section('content')
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="img-magnifier-container">
                                    <img src="{{ asset($product->img_path) }}" class="img-fluid rounded zoomable"
                                        alt="Main Image">
                                </div>
                            </div>
                            ...
                            @foreach ($product_other_imgs as $image)
                                <div class="swiper-slide">
                                    <div class="img-magnifier-container">
                                        <img src="{{ asset($image->img_path) }}" class="img-fluid rounded zoomable"
                                            alt="Product Image">
                                    </div>
                                </div>
                            @endforeach
                            ...
                            @foreach ($variations as $variation)
                                <div class="swiper-slide">
                                    <div class="img-magnifier-container">
                                        <img src="{{ asset($variation->img_path) }}" class="img-fluid rounded zoomable"
                                            alt="Variation Image">
                                    </div>
                                </div>
                            @endforeach
    ...
    ">
                                    ...
                                    "
                                            data-id="{{ $size->id }}"
                                            data-value="{{ $size->symbol }}">{{ $size->symbol }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="sizesMain colorsSelectorMain d-none">
                            ...
                            <ul class="color">
                                @foreach ($colors as $color)
                                    @php
                                        $variations = App\Models\Variation::where('color_id', $color->id)
                                    ...
                                    color-button-item
                                    @foreach ($variations as $variation) 
                                    available-size-{{ $variation->size_id }} @endforeach"
                                        data-id="{{ $color->id }}" data-value="{{ $color->name }}"><a
                                            href="javascript:;" class="color-btn"></a></li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="product-price">
                            ...
                            <span id="product-price-holder"
                                style="font-size: 15px;text-decoration: line-through;margin-top: 0px;">Old Price PKR
                                {{ $product->old_price }}</span> </h3>
                            ...
                            <form action="{{ route('save-cart') }}" method="POST">
                                ...
                                <div class="product-quantity">
                                    ...
                                    <div class="cart-icons cart-quantity-inputs">
                                        ...
                                        <input type="text" class="count count-input" id="" value="1"
                                            min="1" name="qty">
                        ...
                        USD{{ $product->price }}</a> --}}
                            <form method="post" action="{{ route('customizer') }}">
                                ...
                                <input type="hidden" id="customizer-price" name="price"
                                    value="{{ $config['CUSTOMPRODUCTPRICE'] }}">
