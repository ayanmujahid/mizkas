...
<section class="inner_banner">
    ...
    <div class="inner_img inner_img--alt"><img src="{{asset('assets/images/inner_banner/5.png')}}" alt='' class='img__contain'></div>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
...
<section class="about">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="checkout-form section-content">
                            ...
                            <form id="payment-form">
                                ...
                                <span id="button-text">Pay now (Rs: {{ $amount }})</span>
                                </button>
    ...
    @section('css')
        <style>
   .checkout-form{
                background:  rgb(190, 187, 187) !important;
            }
            .payment-box img {
                width: 25%;
            }
