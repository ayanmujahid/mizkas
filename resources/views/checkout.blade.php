    ...
    <div class="container">
        <div class="tf-page-cart-wrap layout-2">
            <div class="tf-page-cart-item">
                ...
                <form action="{{ route('submit-order') }}" method="POST" class="form-checkout">
                    @csrf
                    ...
                    <fieldset class="box fieldset">
                        ...
                        <div class="select-custom">
                            <select class="tf-select w-100" id="country" name="country" data-default="" value="{{old('country')}}">
        ...
        @endphp
                    <div class="tf-page-cart-checkout widget-wrap-checkout">
                        <ul class="wrap-checkout-product">
                            <li class="checkout-product-item">
                                <figure class="img-product">
                                    <img src="{{ ucfirst(asset($product['img_path'])) }}" alt="product">
                            ...
                            <input type="hidden" name="variation_id" value="{{ $v['variaion_id'] }}">
                            @endif
                            @endforeach
                        </ul>
                        ...
                        <div class="wd-check-payment">
                            ...
                            <div class="fieldset-radio mb_20">
                                <input type="radio" name="payment" id="delivery" class="tf-check" required>
