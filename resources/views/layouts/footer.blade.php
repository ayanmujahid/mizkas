        <!-- Footer -->
        <footer id="footer" class="footer background-gray md-pb-70 mt-4">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    ...
                                    <ul>
                                        <li>
                                            <p>Address: A-6, baradari, Gulshan-E-Iqbal <br> Karachi, KHI 75300</p>
                                        </li>
                                        <li>
                                            <p>Email: <a href="mailto:{{$config['COMPANYEMAIL']}}">{{$config['COMPANYEMAIL']}}</a></p>
                                        </li>
                                        <li>
                                            <p>Phone: <a href="#">{{$config['COMPANYPHONE']}}</a></p>
                                        </li>
                                    </ul>
                                    <a href="contact-1.html" class="tf-btn btn-line">Get direction<i
                                            class="icon icon-arrow1-top-left"></i></a>
                                    <ul class="tf-social-icon d-flex gap-10">
                                        <li><a href="https://www.facebook.com/share/1CZX7a9thZ/" target="blank" class="box-icon w_34 round social-facebook social-line"><i
                                                    class="icon fs-14 icon-fb"></i></a></li>
                                        <li><a href="https://www.instagram.com/mizkas_apparel?igsh=bjVtcnozYnA4Mmp4"
                                                class="box-icon w_34 round social-instagram social-line
                                                " target="blank"><i
                                                    class="icon fs-14 icon-instagram"></i></a></li>
                                        <li><a href="https://www.tiktok.com/@mizkas.apparel?_r=1&_t=ZS-91jOwswGTRf" target="blank" class="box-icon w_34 round social-tiktok social-line"><i
                            ...
                            <div class="col-xl-3 col-md-6 col-12 footer-col-block">
                                ...
                                <ul class="footer-menu-list tf-collapse-content">
                                    ...
                                    <li>
                                        <a href="{{route('products')}}" class="footer-menu_item">Visit Our Store</a>
                                    </li>
                                    <li>
                                        <a href="{{route('contact')}}" class="footer-menu_item">Contact Us</a>
                                    </li>
                                    <li>
                                        <a href="{{route('login')}}" class="footer-menu_item">Account</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-newsletter footer-col-block">
                                    ...
                                    <div class="tf-collapse-content">
                                        ...
                                        <form class="form-newsletter" id="subscribe-form" action="{{route('newsletter_submit')}}" method="post"
        ...
        <div class="tf-toolbar-bottom type-1150">
            ...
            <div class="toolbar-item">
                <a href="{{route('cart')}}" >
                    ...
                    @endphp
                    @if ($cartCount > 0)
                        <div class="toolbar-count">{{ $cartCount }}</div>
                        @endif
                    </div>
                ...
                <div class="mb-body">
                        ...
                        <li class="nav-mb-item">
                            ...
                            <div id="dropdown-menu-four" class="collapse">
                                <ul class="sub-nav-menu" id="sub-menu-navigation">
                                    <li><a href="{{route('products')}}" class="sub-nav-link">All Products</a></li>
                                    ...
                                    <li><a href="{{ route('products', $category->slug) }}" class="sub-nav-link">{{ $category->title }}</a></li>
                                    @endforeach
                    ...
                    <div class="mb-other-content">
                        <div class="d-flex group-icon">
                            ...
                            <a href="#canvasSearch" class="site-nav-icon" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft"><i
                        ...
                        <ul class="mb-info">
                            <li>Address: Shop# 219, Gulshan-E-Iqbal <br> Karachi, KHI 75300</li>
                            <li>Email: <b>{{$config['COMPANYEMAIL']}}</b></li>
                            <li>Phone: <b>{{$config['COMPANYPHONE']}}</b></li>
                        </ul>
                    </div>
                </div>
                <div class="mb-bottom">
                    @if (Auth::check())
                    <a href="{{route('logout')}}" class="site-nav-icon"><i class="icon icon-logout"></i>Logout</a>
                    @else
            ...
            <div class="canvas-wrapper">
                <header class="tf-search-head">
                    ...
                    <div class="tf-search-sticky">
                        <form action="{{route('products')}}" class="tf-mini-search-frm">
                            <fieldset class="text">
                                <input type="text" placeholder="Search" class="" name="search"
                                    tabindex="0" value="{{isset($_GET['search']) ? $_GET['search'] : ''}}" aria-required="true" required="">
                            </fieldset>
            ...
            <div class="mb-canvas-content">
                <div class="mb-body">
                    <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                        @foreach ($categories as $category)
                        <li class="nav-mb-item">
                            <a href="{{ route('products', $category->slug) }}" class="tf-category-link mb-menu-link">
                                <div class="image">
                ...
                <div class="mb-bottom">
                    <a href="{{ route('products') }}" class="tf-btn fw-5 btn-line">View all collection<i
                            class="icon icon-arrow1-top-left"></i></a>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="tf-login-form">
                        <form class="" action="{{route('login-submit')}}"
                            ...
                            <div class="tf-field style-1">
                                <input class="tf-field-input tf-input" placeholder=" " name="login_password"
                                    type="password">
        ...
        <div class="modal modalCentered fade form-sign-in modal-part-content" id="forgotPassword">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="tf-login-form">
                        <form class="" action="{{ route('forget_password_submit') }}" method="post">
                            @csrf
                            <div>
        ...
        <div class="modal modalCentered fade form-sign-in modal-part-content" id="register">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="tf-login-form">
                        <form class="" action="{{ route('sign-up-submit') }}" method="post">
                            @csrf
                            <div class="tf-field style-1">
