            ...
            <li
                ...
                <div class="custom-dropdown__values">
                    <ul class="values-wrapper">
                        ...
                        <li><a class="{{ Request::url() == route('admin.color_listing') ? 'active' : '' }}"
                                href="{{ route('admin.color_listing') }}">Color Management</a></li>
                        <li><a class="{{ Request::url() == route('admin.size_listing') ? 'active' : '' }}"
                                href="{{ route('admin.size_listing') }}">Size Management</a></li>
                        ...
                        <li><a href="{{ route('admin.variation_listing') }}">Variation Management</a></li>
                    </ul>
                </div>
            </li>
