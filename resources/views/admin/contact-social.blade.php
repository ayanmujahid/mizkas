        ...
        <div class="main-wrapper">
            ...
            <form action="{{ route('admin.saveSocialInfo') }}" method="POST" class="main-form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            <label>Customized Product Price:</label>
                            <div class="relative-div">
                                <input type="text" name="CUSTOMPRODUCTPRICE" required class="form-control"
                                    value="{{ $config['CUSTOMPRODUCTPRICE'] }}" placeholder="Enter Your Customized Product Price">
                            </div>
                        </div>
                    </div>
