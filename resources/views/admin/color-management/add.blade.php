...
<div class="main-sec">
      <div class="main-wrapper">
        ...
        <form action="{{route('admin.create_color')}}" method="POST" class="main-form create_user_form">
            @csrf
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-12">
              <div class="form-group">
                ...
                <div class="d-flex ">
                <input type="color" name="color"  id="colorInput" class="form-control color-input" placeholder="Select Color">
                <input type="text" name=""  id="colortext" class="form-control ml-3" placeholder="Select Color">
              </div>
              </div>
              @if ($errors->has('color'))
