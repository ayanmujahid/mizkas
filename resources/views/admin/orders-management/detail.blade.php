                    ...
                    <div class="invoice">
                        ...
                        <div class="invoice_details">
                            <ul>
                                ...
                                {{-- <li>
                                    <span class="key">Product Size:</span>
                                    <span class="value">
                                        {{ optional($order->variation->variationBelongsToSize)->name }}
                                    </span>
                                </li> --}}
                                ...
                                <li><span class="key">Order Amount:</span> <span
                                        class="value">RS:{{ $order->total_amount ?? 'N/A' }}</span></li>
                                ...
                                <li><span class="key"> Town/city:</span> <span
                                        class="value">{{ $order->town ?? 'N/A' }}</span>
                                </li>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($order_detail as $od)
                                        <tr>
                                            <td>{{ $num }}</td>
                                            <td>
                                                @if (isset($od['custom']) && $od['custom'] == 1)
                                                    <img width="80px" height="" src="{{ $od['image'] }}">
                                                @else
                                            ...
                                            <td style="width: 50%">{{ ucfirst($od['name'] ?? '') }}
                                                ...
                                                @if (isset($od['custom']) && $od['custom'] == 1)
                                                    (Customized)
                                                    <br>
                                                    <a href="{{ $od['image'] }}" download> Download Image</a>
                                                @endif
                                            </td>

                                            <td>RS:{{ $od['price'] }}</td>
                                            <td>RS:{{ $od['sub_total'] }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>RS:{{ $config['SHIPPINGPRICE'] }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">Total:</td>
                                        <td>RS:{{ $grand_total + $config['SHIPPINGPRICE'] }}</td>
                                    </tr>
